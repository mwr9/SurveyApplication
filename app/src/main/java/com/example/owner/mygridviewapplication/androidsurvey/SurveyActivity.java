package com.example.owner.mygridviewapplication.androidsurvey;
...
import com.example.owner.mygridviewapplication.androidsurvey.adapters.AdapterFragmentQ;
import com.example.owner.mygridviewapplication.androidsurvey.fragment.FragmentCheckboxes;
import com.example.owner.mygridviewapplication.androidsurvey.fragment.FragmentEnd;
import com.example.owner.mygridviewapplication.androidsurvey.fragment.FragmentMultiline;
import com.example.owner.mygridviewapplication.androidsurvey.fragment.FragmentNumber;
import com.example.owner.mygridviewapplication.androidsurvey.fragment.FragmentRadioboxes;
import com.example.owner.mygridviewapplication.androidsurvey.fragment.FragmentStart;
import com.example.owner.mygridviewapplication.androidsurvey.fragment.FragmentTextSimple;
import com.example.owner.mygridviewapplication.androidsurvey.models.Question;
import com.example.owner.mygridviewapplication.androidsurvey.models.SurveyPojo;
...
public class SurveyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!mSurveyPojo.getSurveyProperties().getSkipIntro()) {
            ...
            sBundle.putSerializable("survey_properties", mSurveyPojo.getSurveyProperties());
        ...
        eBundle.putSerializable("survey_properties", mSurveyPojo.getSurveyProperties());
